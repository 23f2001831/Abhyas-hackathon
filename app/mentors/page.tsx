      ...
      <main className="container mx-auto px-4 py-8">
        <div className="space-y-6">
          ...
          <section className="text-center space-y-4">
            <h1 className="text-4xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-600">AI Mentors</h1>
          ...
          <Tabs defaultValue="technical" value={activeTab} onValueChange={setActiveTab} className="space-y-8">
            <TabsList className="grid grid-cols-2 md:grid-cols-4 gap-2 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-0 shadow-lg p-1">
              {mentorTypes.map((type) => (
                <TabsTrigger key={type.id} value={type.id} className="flex items-center gap-2 data-[state=active]:bg-gradient-to-r data-[state=active]:from-violet-600 data-[state=active]:to-indigo-600 data-[state=active]:text-white transition-all duration-200">
              ...
              <TabsContent key={type.id} value={type.id} className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {type.mentors.map((mentor) => (
                    <Card key={mentor.id} className="overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border-0 bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm">
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap gap-1">
                              {mentor.skills.map((skill) => (
                                <Badge key={skill} className="font-normal bg-gradient-to-r from-violet-500/20 to-indigo-500/20 text-violet-700 dark:text-violet-300 border-violet-300 dark:border-violet-700">
                                  {skill}
                                </Badge>
                              ))}
                            </div>
          ...
          <section className="py-12 space-y-6">
            <div className="text-center space-y-4">
              <h2 className="text-3xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-violet-600 to-indigo-600">Subscription Plans</h2>
          ...
          <section className="py-12 space-y-6">
            <div className="text-center space-y-4">
              <h2 className="text-3xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-violet-600 to-indigo-600">Educational Partners</h2>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
