...
function SkillsPageContent() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-50 via-purple-50/30 to-indigo-50/20 dark:from-slate-900 dark:via-purple-900/20 dark:to-slate-900">
      <ResponsiveNavbar />
        ...
        <div className="container px-4 md:px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
              <div>
                <h1 className="text-4xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-600">Skills Dashboard</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
              <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-violet-50 to-violet-100/50 dark:from-violet-950/50 dark:to-violet-900/30">
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-indigo-50 to-indigo-100/50 dark:from-indigo-950/50 dark:to-indigo-900/30">
                <CardContent className="pt-6">
                  <div className="flex items-center">
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-amber-50 to-amber-100/50 dark:from-amber-950/50 dark:to-amber-900/30">
                <CardContent className="pt-6">
                  <div className="flex items-center">
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-emerald-50 to-emerald-100/50 dark:from-emerald-950/50 dark:to-emerald-900/30">
                <CardContent className="pt-6">
                  <div className="flex items-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
              ...
              <div className="lg:col-span-1">
                <Card className="sticky top-4 border-0 shadow-xl bg-white/80 dark:bg-slate-900/80 backdrop-blur-md">
                  <CardHeader>
                    <CardTitle className="bg-clip-text text-transparent bg-gradient-to-r from-violet-600 to-indigo-600">Categories</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-2">
                      {skillCategories.map((category) => (
                        <Button
                          ...
                          className={`w-full justify-start transition-all duration-200 ${selectedCategory === category.id ? 'bg-gradient-to-r from-violet-600 to-indigo-600 shadow-lg' : 'hover:bg-violet-50 dark:hover:bg-violet-950/30'}`}
                  ...
                  <CardFooter>
                    <div className="relative w-full">
                      ...
                      <Input
                        ...
                        className="pl-8 border-violet-200 dark:border-violet-800 focus:ring-violet-500"
                        value={searchQuery}
                      ...
                      <div className="grid grid-cols-1 gap-6">
                        {filteredSkills.map((skill) => (
                          <motion.div
                            ...
                            transition={{ duration: 0.3 }}
                          >
                            <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm overflow-hidden relative before:absolute before:inset-0 before:opacity-0 before:transition-opacity before:duration-300 hover:before:opacity-100 before:bg-gradient-to-r before:from-violet-500/5 before:to-indigo-500/5">
                              <CardHeader>
                                <div className="flex justify-between items-start">
                                  <div>
                                    <CardTitle className="bg-clip-text text-transparent bg-gradient-to-r from-violet-600 to-indigo-600">{skill.name}</CardTitle>
                                    <CardDescription>{skill.description}</CardDescription>
                                  </div>
                                  <Badge className="ml-2 bg-gradient-to-r from-violet-600 to-indigo-600 text-white border-0">
                                    {skill.category}
                                  </Badge>
                                </div>
                              </CardHeader>
                                      ...
                                      {getChallengesForSkill(skill.id).length > 0 ? (
                                        <div className="space-y-2">
                                          {getChallengesForSkill(skill.id).map((challenge) => (
                                            <div
                                              key={challenge.id}
                                              className="flex justify-between items-center p-3 border border-violet-200 dark:border-violet-800 rounded-lg bg-gradient-to-r from-violet-50/50 to-indigo-50/50 dark:from-violet-950/30 dark:to-indigo-950/30 hover:from-violet-100 hover:to-indigo-100 dark:hover:from-violet-900/50 dark:hover:to-indigo-900/50 cursor-pointer transition-all duration-200 hover:shadow-md hover:-translate-y-0.5"
                                            ...
                                            >
                                              ...
                                              <Badge className="bg-gradient-to-r from-amber-500 to-orange-500 text-white border-0">{challenge.xpReward} XP</Badge>
                                            </div>
                                          ))}
                                        </div>
                                      ) : (
