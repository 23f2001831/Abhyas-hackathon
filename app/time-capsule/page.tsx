...
function TimeCapsulePageContent() {
  const { user } = useAuth()
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-50 via-amber-50/30 to-yellow-50/20 dark:from-slate-900 dark:via-amber-900/20 dark:to-slate-900">
      <Navbar />
