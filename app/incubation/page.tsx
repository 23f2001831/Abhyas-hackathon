...
function IncubationRoomContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50/30 to-emerald-50/20 dark:from-slate-900 dark:via-green-900/20 dark:to-slate-900">
      <div className="container py-8">
        <h1 className="text-3xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600">Live Incubation Room</h1>
