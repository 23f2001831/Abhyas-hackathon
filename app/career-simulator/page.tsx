...
// Tech careers with detailed information
const techCareers = [
  {
    ...
    skills: ["React", "Node.js", "TypeScript", "Database Design", "API Development", "DevOps"],
    ...
    tools: ["VS Code", "Git", "Docker", "PostgreSQL", "React", "Node.js", "AWS/GCP"],
    challenges: [
    ...
    successStories: [
      { name: "Sarah Chen", achievement: "Built a SaaS platform serving 100K+ users" },
      { name: "Mike Rodriguez", achievement: "Transitioned from bootcamp to FAANG in 2 years" },
      { name: "Emma Wilson", achievement: "Founded a successful startup after 3 years of development experience" },
    ],
  },
  {
    id: "data-scientist",
    ...
    growthRate: "+36% (2020-2030)",
    workEnvironment: "Office, Remote, Research Labs",
    ...
    tools: ["Python", "Jupyter", "Pandas", "Scikit-learn", "TensorFlow", "Tableau", "SQL"],
    challenges: [
    ...
    successStories: [
      { name: "Dr. Priya Patel", achievement: "Developed fraud detection system saving $50M annually" },
      { name: "James Liu", achievement: "Built recommendation engine increasing engagement by 40%" },
      { name: "Ana Santos", achievement: "Published research on NLP that was adopted by major tech companies" },
    ],
  },
  {
    id: "devops-engineer",
    name: "DevOps Engineer",
    description: "Build and maintain infrastructure, CI/CD pipelines, and deployment systems",
    icon: "/placeholder.svg?height=80&width=80",
    skills: ["Linux", "Kubernetes", "CI/CD", "Cloud Platforms", "Infrastructure as Code", "Monitoring"],
    averageSalary: "$115,000",
    growthRate: "+21% (2020-2030)",
    workEnvironment: "Office, Remote, On-call rotations",
    ...
    tools: ["Docker", "Kubernetes", "Terraform", "Jenkins", "AWS/Azure/GCP", "Prometheus", "Grafana"],
    challenges: [
    ...
    successStories: [
      { name: "Tom Anderson", achievement: "Reduced deployment time from hours to minutes" },
      { name: "Lisa Park", achievement: "Achieved 99.99% uptime for critical systems" },
      { name: "Raj Sharma", achievement: "Built platform supporting 10x traffic growth" },
    ],
  },
  {
    id: "ai-ml-engineer",
    name: "AI/ML Engineer",
    description: "Design and deploy artificial intelligence and machine learning systems",
    icon: "/placeholder.svg?height=80&width=80",
    skills: ["Deep Learning", "PyTorch/TensorFlow", "MLOps", "Computer Vision", "NLP", "Model Optimization"],
    averageSalary: "$140,000",
    growthRate: "+40% (2020-2030)",
    workEnvironment: "Office, Remote, Research Labs",
    education: "Master's/PhD in ML, AI, or related field",
    dailyTasks: [
    ...
    tools: ["PyTorch", "TensorFlow", "Hugging Face", "MLflow", "Weights & Biases", "CUDA", "Ray"],
    challenges: [
      "Keeping up with rapid research advances",
      "Managing expensive compute resources",
      "Ensuring model fairness and safety",
    ],
    successStories: [
      { name: "Dr. Wei Zhang", achievement: "Developed LLM that powers millions of conversations daily" },
      { name: "Sofia Rossi", achievement: "Created computer vision system used in autonomous vehicles" },
      { name: "Marcus Johnson", achievement: "Built AI assistant that reduced customer service costs by 60%" },
    ],
  },
];
...
const techCourses = [
  {
    ...
    testimonials: [
      { name: "Alex M.", comment: "This course helped me land my first dev job within 3 months of completing it." },
      { name: "Jordan K.", comment: "The projects are incredibly practical. I still use them in my portfolio." },
    ],
  },
  {
    ...
    testimonials: [
      { name: "Priya S.", comment: "The best ML course I've taken. Dr. Ng explains complex concepts beautifully." },
      { name: "David L.", comment: "Transformed my understanding of ML. Highly recommended for anyone starting out." },
    ],
  },
  {
    id: "cloud-devops",
    ...
    description: "Master cloud infrastructure, Kubernetes, and modern DevOps practices.",
    topics: [
    ...
    testimonials: [
      { name: "Chris T.", comment: "Finally understood Kubernetes after taking this course. Game changer for my career." },
      { name: "Sam K.", comment: "The hands-on labs are incredible. I learned more here than in 6 months on the job." },
    ],
  },
];
...
export default function CareerSimulatorPage() {
  ...
  const getCareers = () => {
    switch (selectedCategory) {
      ...
      case "music":
        return musicCareers;
      default:
        return musicCareers; // Fallback to music for other categories
    }
  };
  ...
  const getMicroTasks = () => {
    switch (selectedCategory) {
      case "tech":
        return techMicroTasks;
      case "music":
        return musicMicroTasks;
      default:
        return musicMicroTasks;
    }
  };
  ...
  const handleCategoryChange = (category) => {
    ...
    // Set the first career of the new category
    if (category === "tech") {
      setSelectedCareer(techCareers[0]);
    } else if (category === "music") {
      setSelectedCareer(musicCareers[0]);
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50/30 to-indigo-50/20 dark:from-slate-900 dark:via-purple-900/20 dark:to-slate-900">
      <ResponsiveNavbar />
      ...
      <main className="container mx-auto py-8 px-4 pt-20">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid grid-cols-2 md:grid-cols-4 lg:w-auto bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-0 shadow-lg">
            <TabsTrigger value="overview" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-violet-600 data-[state=active]:to-indigo-600 data-[state=active]:text-white">Overview</TabsTrigger>
            <TabsTrigger value="tasks" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-violet-600 data-[state=active]:to-indigo-600 data-[state=active]:text-white">Micro-Tasks</TabsTrigger>
            <TabsTrigger value="courses" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-violet-600 data-[state=active]:to-indigo-600 data-[state=active]:text-white">Courses</TabsTrigger>
            <TabsTrigger value="events" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-violet-600 data-[state=active]:to-indigo-600 data-[state=active]:text-white">Events</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="overview" className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-1">
                <h3 className="text-xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-violet-600 to-indigo-600">
                ...
                <div className="space-y-4">
                  {getCareers().map((career) => (
                    <motion.div
                      ...
                      whileTap={{ scale: 0.98 }}
                      className={`cursor-pointer rounded-xl overflow-hidden border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${
                        selectedCareer.id === career.id
                          ? "border-violet-500 bg-gradient-to-r from-violet-50 to-indigo-50 dark:from-violet-950/50 dark:to-indigo-950/50 shadow-lg"
                          : "border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm"
                      }`}
                    ...
                    >
                      <div className="p-4 flex items-center gap-4">
                        <div className={`w-16 h-16 rounded-full flex items-center justify-center text-white text-2xl overflow-hidden ${
                          ...
                          {/* Tech career icons */}
                          {career.id === "fullstack-developer" && "💻"}
                          {career.id === "data-scientist" && "📊"}
                          {career.id === "devops-engineer" && "⚙️"}
                          {career.id === "ai-ml-engineer" && "🤖"}
                          {/* Music career icons */}
                          {career.id === "music-producer" && "🎧"}
                          {career.id === "composer" && "🎼"}
                          {career.id === "music-teacher" && "👨‍🏫"}
                          {career.id === "performing-musician" && "🎸"}
                          {career.id === "music-therapist" && "🎵"}
                        </div>
                        <div>
              ...
              <div className="lg:col-span-2">
                <Card className="border-0 shadow-xl bg-white/90 dark:bg-slate-900/90 backdrop-blur-md overflow-hidden">
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <div className={`w-16 h-16 rounded-full flex items-center justify-center text-white text-2xl overflow-hidden ${
                          ...
                          {/* Tech career icons */}
                          {selectedCareer.id === "fullstack-developer" && "💻"}
                          {selectedCareer.id === "data-scientist" && "📊"}
                          {selectedCareer.id === "devops-engineer" && "⚙️"}
                          {selectedCareer.id === "ai-ml-engineer" && "🤖"}
                          {/* Music career icons */}
                          ...
                          {selectedCareer.id === "music-therapist" && "🎵"}
                        </div>
                        <div>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {selectedCareer.skills.map((skill, index) => (
                          <Badge key={index} className="bg-gradient-to-r from-violet-500/20 to-indigo-500/20 text-violet-700 dark:text-violet-300 border-violet-300 dark:border-violet-700">
                            {skill}
                          </Badge>
                        ))}
                      </div>
