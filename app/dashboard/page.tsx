...
function DashboardPageContent() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/20 dark:from-slate-900 dark:via-purple-900/20 dark:to-slate-900">
      <ResponsiveNavbar />
        ...
        <AnimatePresence>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <section className="mb-8">
              <Card className="border-0 overflow-hidden shadow-xl bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 text-white">
                  ...
                  <div className="relative flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-right">
                        <p className="text-sm font-medium text-white/70">Weekly Progress</p>
                        <p className="text-3xl font-bold">67%</p>
                      </div>
                      <div className="h-20 w-20 overflow-hidden rounded-full border-4 border-white/30 bg-white/20 backdrop-blur-sm p-1">
                    ...
                    <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                      ...
                      <CardContent>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          {(showAllRecommendations ? careerData.recommendations : careerData.recommendations.slice(0, 4)).map((item, index) => (
                            <motion.div
                              key={index}
