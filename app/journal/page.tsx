...
import { useAuth, type JournalEntry } from "@/components/auth-provider"
...
function JournalPageContent() {
  ...
  const handleJournalSubmit = () => {
    ...
    setTimeout(() => {
      ...
      const newEntry: JournalEntry = {
        id: `entry-${Date.now()}`,
        title: journalEntry.substring(0, 50) + (journalEntry.length > 50 ? "..." : ""),
        content: journalEntry,
        mood: selectedMood,
        date: new Date().toISOString(),
        tags: [selectedMood, detectedEmotion].filter(Boolean),
      }
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-50 via-rose-50/30 to-orange-50/20 dark:from-slate-900 dark:via-rose-900/20 dark:to-slate-900">
      <Navbar />
      ...
      <div className="flex-1 pt-16 pb-8">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-rose-600 via-pink-600 to-orange-600">Emotion+AI Journal Assistant</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2">
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                <TabsList className="grid grid-cols-3 mb-4 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-0 shadow-lg">
                  <TabsTrigger value="write" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-rose-500 data-[state=active]:to-orange-500 data-[state=active]:text-white">Write Journal</TabsTrigger>
                  <TabsTrigger value="history" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-rose-500 data-[state=active]:to-orange-500 data-[state=active]:text-white">Journal History</TabsTrigger>
                  <TabsTrigger value="tasks" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-rose-500 data-[state=active]:to-orange-500 data-[state=active]:text-white">Mood Tasks</TabsTrigger>
                </TabsList>
            ...
            <div className="lg:col-span-1">
              <Card className="border-0 shadow-lg bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm mb-6">
                <CardHeader>
                  <CardTitle className="flex items-center">
