...
import { ArrowLeft, Download, FileText, Plus, Trash2, Sparkles, Check, Palette, Loader2 } from "lucide-react"
...
function ResumeBuilderPageContent() {
  ...
  const handleGenerateResume = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: `Your ${resumeTemplates.find(t => t.id === selectedTemplate)?.name} resume has been created with the ${colorSchemes.find(c => c.id === selectedColorScheme)?.name} color scheme.`,
      })
    }, 1500)
  }
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-50 via-blue-50/30 to-cyan-50/20 dark:from-slate-900 dark:via-blue-900/20 dark:to-slate-900">
      <Navbar />
      ...
      <div className="flex-1 pt-16 pb-8">
        <div className="container px-4 md:px-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <Button onClick={handleGenerateResume} disabled={isGenerating} className="btn-hover">
              {isGenerating ? (
