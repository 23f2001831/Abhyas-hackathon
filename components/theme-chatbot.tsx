...
export function ThemeChatbot() {
  ...
  const getIdeaResponse = () => {
    switch (currentEmotion) {
      ...
      default:
        return "I'd be happy to help with ideas! The Abhyas platform has several tools that might inspire you. Would you like to explore the Magic Box for creative prompts or check out what other students are working on?"
    }
  }
  ...
  const getGeneralResponse = () => {
    const responses = [
      ...
      "The Abhyas platform has many tools designed to help you thrive. Is there a specific area you'd like to focus on today?",
